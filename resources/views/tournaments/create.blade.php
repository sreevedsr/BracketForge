<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-2xl leading-tight text-gray-900 dark:text-gray-100 transition-colors duration-300">
            Create Tournament
        </h2>
    </x-slot>
    ...
    <script>
        function tournamentForm() {
            return {
                participantsCount: 2,
                increase() {
                    if (this.participantsCount < 32) this.participantsCount++;
                },
                decrease() {
                    if (this.participantsCount > 2) this.participantsCount--;
                }
            }
        }
    </script>
